...
final class DMExpenseTrackerBasicTests: XCTestCase {
    func testCalculateTotalSpent() throws {
        for _ in 1...100 {
            ...
            XCTAssertEqual(ExpenseHelper.calculateTotalSpent(for: expenses), expenses.reduce(0) { $0 + $1.amount })
        }
    }
    
    func getExpensesByCategory() throws {
        ...
        for _ in 1...100 {
            ...
            let expensesByCategory = ExpenseHelper.getExpensesByCategory(for: expenses)
